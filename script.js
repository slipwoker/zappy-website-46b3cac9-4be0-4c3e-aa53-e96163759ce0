    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                const errorKey = errorMessages[name] ? errorMessages[name].required : 'This field is required';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '46b3cac9-4be0-4c3e-aa53-e96163759ce0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '46b3cac9-4be0-4c3e-aa53-e96163759ce0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '46b3cac9-4be0-4c3e-aa53-e96163759ce0';
